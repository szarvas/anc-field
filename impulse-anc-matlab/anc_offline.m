...
anc = iELMS(1500, 8000, 200, fs);

anc.SetSecondaryPath(file_to_variable('s2/actuator_to_error.dat'));
...
anc.SetNoiseToError( file_to_variable('s2/noise_to_error.dat') );

anc.AddReference( file_to_variable('s2/noise_to_reference_front.dat'), ...
                  file_to_variable('s2/actuator_to_reference_front.dat'));
              
anc.AddReference( file_to_variable('s2/noise_to_reference_back.dat'), ...
                  file_to_variable('s2/actuator_to_reference_back.dat'));
