...
anc.SetSecondaryPath(file_to_variable('tube_actuator_to_error.dat'));
...
anc.s_ = file_to_variable('tube_actuator_to_error.dat');

% anc.Identify(80000);

anc.SetNoiseToError( file_to_variable('tube_noise_to_error.dat') );

anc.AddReference( file_to_variable('tube_noise_to_reference.dat'), ...
                  file_to_variable('tube_actuator_to_reference.dat'));
